...
class ProduitsEte extends StatefulWidget {
  const ProduitsEte({Key? key}) : super(key: key);

  @override
  _ProduitsEteState createState() => _ProduitsEteState();
}

class _ProduitsEteState extends State<ProduitsEte> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection("produits").where('cate', isEqualTo: "ete").snapshots(),
