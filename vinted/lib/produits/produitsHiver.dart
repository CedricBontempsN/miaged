...
class ProduitsHiver extends StatefulWidget {
  const ProduitsHiver({Key? key}) : super(key: key);

  @override
  _ProduitsHiverState createState() => _ProduitsHiverState();
}

class _ProduitsHiverState extends State<ProduitsHiver> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection("produits").where('cate', isEqualTo: "hiver").snapshots(),
